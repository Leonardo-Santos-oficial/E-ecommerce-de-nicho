export default function AdditionalServices() {
  return (
    <section aria-labelledby="servicos-adicionais" className="card p-4">
      <h2 id="servicos-adicionais" className="text-lg font-semibold mb-3">Serviços adicionais</h2>
      <div className="flex items-start gap-3">
        ...
        <label htmlFor="garantia" className="text-sm text-slate-300">
          ...
          <div className="text-xs text-slate-400">Proteja seu produto por mais tempo com assistência especializada.</div>
        </label>
      </div>
    </section>
  )
